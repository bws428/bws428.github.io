...
t/Space CXV Splashdown
t/Space CXVRecovery appears to be a fruitful way of reducing the cost, but only if it can be done with a minor increase in complexity or a very small reduction in payload mass. Recovering the Shuttle's solid rocket boosters costs only a fraction of 1% of the mission cost of the Shuttle (it should cost only a few thousand dollars, and although it actually costs NASA about 10 times that, the retrieval cost is still a negligible fraction of the total operational mission cost). if refurbishing the solid rockets were not so expensive, the approach would be very cost-effective.
